...
public class View {
    ...
    public static void view() {
        ...
        System.out.print("|    ");
        System.out.print(Main.allies.get(0).getInfo());
        tabSetter(Main.allies.get(0).getInfo().length(), l[0]);
        System.out.println(Main.enemies.get(0).getInfo());
        ...
        for (int i = 2; i < 10; i++) {
            ...
            System.out.print("|    ");
            System.out.print(Main.allies.get(i - 1).getInfo());
            tabSetter(Main.allies.get(i - 1).getInfo().length(), l[0]);
            System.out.println(Main.enemies.get(i - 1).getInfo());
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        System.out.print("|    ");
        System.out.print(Main.allies.get(9).getInfo());
        tabSetter(Main.allies.get(9).getInfo().length(), l[0]);
        System.out.println(Main.enemies.get(9).getInfo());
